"""Native cognis-connect emit for jtf-meridian — forward findings to any platform.

Maps jtf-meridian's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    jtf-meridian ... --format json | jtf-meridian-emit --to stix
    jtf-meridian-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
